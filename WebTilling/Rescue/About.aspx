...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>A novel durum exome capture reference (DECaR) was built from available durum whole genome assemblies: reads from the unmutagenized control sample were mapped into two publically available durum wheat whole genome assemblies of 
        <a href="https://www.interomics.eu/durum-wheat-genome-disclosure-agreement">Svevo</a> + <a href="https://opendata.earlham.ac.uk/opendata/data/Triticum_turgidum/EI/v1.1/">Kronos EI v1</a> , and then combined with 
        assembled unmapped control reads. Putative mutations were identified by comparing the CD reference with each mutant plant’s sequence. 
