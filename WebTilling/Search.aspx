...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <fieldset>
        ...
        <div class="col-md-4 form-group">
            ...
            <asp:TextBox ID="txtContig" runat="server" CssClass="form-control" placeholder="i.e. ctg000060" Text="ctg000060" OnPreRender="txtContig_PreRender" CausesValidation="True" MaxLength="18" />
    ...
    <fieldset>
        ...
        <div class="col-md-4 form-group">
            ...
            <asp:TextBox ID="txtMut" runat="server" CssClass="form-control " placeholder="Number" OnPreRender="txtMut_PreRender" CausesValidation="True" MaxLength="6" />
        ...
        <div class="col-sm-12">
            ...
            <asp:GridView ID="gridMutations" runat="server" AutoGenerateColumns="False" DataKeyNames="mutID" DataSourceID="SQLiteDataMutations" CssClass="table table-bordered table-condensed table-hover" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ctg" HeaderText="CD Contig" SortExpression="ctg" ReadOnly="True" />
...
<%--                    <asp:BoundField DataField="flankStart" HeaderText="Start"  SortExpression="flankStart" ReadOnly="True" />
                    <asp:BoundField DataField="flankEnd" HeaderText="End"  SortExpression="flankEnd" ReadOnly="True" />--%>
...
<%-- !!!!!!!!!!!!!              <a href="#" data-toggle="collapse" data-target='#div<%# Eval("mutID") %>' class="accordion-toggle" ><%# Eval("flankSeq") %></a>
...
<%--    <asp:SqlDataSource ID="SqlDataMutations" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SelectMutations" SelectCommandType="StoredProcedure">
        <SelectParameters>
		    ...
		    <asp:ControlParameter ControlID="txtMut" DefaultValue="-1" Name="mut" PropertyName="Text" Type="Int32" />
		</SelectParameters>
    </asp:SqlDataSource>--%>
<%--    <asp:SqlDataSource ID="SQLiteDataMutations" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT mutID, mutant, ctg, position, mutType, mutAllele, parentAllele, zygosity, depth, chr, flankStart, flankEnd, flankSeq, assemblyID FROM Mutations ORDER BY depth DESC"></asp:SqlDataSource>--%>
