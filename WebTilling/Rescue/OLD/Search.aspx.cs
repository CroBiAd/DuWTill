...
namespace WebTilling {
    public partial class Search:System.Web.UI.Page {
        protected void Page_Load(object sender, EventArgs e) {
            ...
            SQLiteDataMutations.SelectCommand += "WHERE CASE WHEN length(@cont)>0 OR @mut>0 THEN (";
            ...
            SQLiteDataMutations.SelectCommand += "AND CASE WHEN @mut>0 THEN mutant=@mut ELSE 1 END) END ORDER BY depth DESC";
        }
        ...
        protected void gridMutations_RowDataBound(object sender, GridViewRowEventArgs e) {
            ...
            if (r.RowType == DataControlRowType.Header) {
                ...
                r.Cells[3].ToolTip = "Mutation position on a CD contig.";
                ...
                txt.Text = @">#" + v["mutID"] + ": TA00285-7_mutant" + v["mutant"].ToString() + "_M2 " + v["mutType"] + " at position " + v["position"].ToString() + " on " + v["ctg"] + Environment.NewLine.Normalize() + v["flankSeq"];
            }
        }
    }
}